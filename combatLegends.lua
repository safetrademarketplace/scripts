...
-- StarterGui.Cerberus.PhoneButton.UIGradient
...
-- StarterGui.Cerberus.PhoneButton.UIAspectRatioConstraint
InfLoadGui["7"] = Instance.new("UIAspectRatioConstraint", InfLoadGui["2"]);
InfLoadGui["7"]["AspectRatio"] = 1.00454;


-- StarterGui.Cerberus.PhoneButton.ImageButton
...
--------------------------------------
-- StarterGui.Cerberus.LoadingScreen
...
-- StarterGui.Cerberus.LoadingScreen.Icon
...
-- StarterGui.Cerberus.LoadingScreen.LoadLabel
        ...
        Fluent:Notify(
            {
                ...
                SubContent = "If the problem continues, If the problem continues, please report it in the Cerberus discord'.",
                Duration = 5
            }
        )
...
if userDevice == "Phone" then
    local otherGui = CoreGui:FindFirstChild("CerberusPhone") or player.PlayerGui:FindFirstChild("CerberusPhone")
    ...
    InfPhoneGui["1"]["Name"] = [[CerberusPhone]];
...
Tab.Player:AddButton(
    {
        Title = "Teleport",
        Description = "Teleport to where your looking with 'e'",
        Callback = function()
            local Players = game:GetService("Players")
...
Tab.Player:AddToggle("MyToggle",
    {
        ...
        Description = "Works on Molotov and BearTrap",
        Default = false,
        Callback = function(state)
            if state then
...
-------- JumpPower
------------------ JumpPower
local Toggle = Tab.Player:AddToggle("MyToggle", {Title = "Jump Height", Default = false})
Toggle:OnChanged(
    function(value)
        if value then
...
local ABStickyAim = Tab.Legit:AddToggle("MyToggle",
    {
        Title = "Sticky Aim",
        Description = "Targets one player",
...
local ParryToggle = Tab.Parry:AddToggle(
    ...
    {
        Title = "Auto-Parry",
        Description = "Works best when standing still",
        Default = false,
        Callback = function(state)
            if state then
...
local PChanceSlider = Tab.Parry:AddSlider(
    ...
    {
        Title = "Parry Chance",
        Description = "Recommended for legit play",
                ...
                Fluent:Notify(
                    {
                        Title = "Error",
                        Content = "Problem Error: 00x1b",
                        SubContent = "If the problem continues, please report it in the Cerberus discord'.",
                        Duration = 5
                    }
                )
            end
...
local NameInput = Tab.Changer:AddInput("Input",
    {
        Title = "Name Changer",
        Default = "",
        Placeholder = "Name",
